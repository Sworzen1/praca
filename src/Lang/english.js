...
const english = {
    ...
    ltitle4:"Salad with feta cheese",
    ...
    ldescription4:"Cripsy vegetables salad with sprouts and feta cheese",
    ...
    sutitle1:"Courgette cakes",
    sutitle2:"Salad with grape",
    sutitle3:"Cakes with banana",
    sutitle4:"Porridge with lyophilized fruits",
    sutitle5:"Green coctail",
    sutitle6:"Yogurt coctail",
    sudescription1:"Crispy courgette cakes with onion",
    sudescription2:"Salad with grapes, brie cheese and sunflower",
    sudescription3:"Tasty yogurt cakes with bananas",
    sudescription4:"Nutritious porridge with lyophilized fruits",
    sudescription5:"Coctail with kale, apple, pear and strawberries",
    sudescription6:"Yogurt coctail with mango and watermelon",
    surecipe1:"Grate 2 courgettes on a grater with thick mesh and squeeze out the water. Cut small onion into small cubes. In a bowl, mix 20g flour with salt and pepper. Insert the egg into a bowl, beat with a whisk and pour into flour. Mix everything until smooth, homogeneous. Give a tablespoon of milk and mix again with a whisk. Add onion and impressed zucchini to the mass. Mix. Heat oil in a frying pan, apply a spoonful of mass to one cake. Brown on both sides. ",
    surecipe2:"Half a handful of arugula, a handful of lamb's lettuce and a few grapes, wash, dry. Prepare the sauce - mix a tablespoon of olive oil, half a teaspoon of balsamic vinegar and honey, lemon juice. Arrange the rocket, lamb's lettuce, chopped grapes in half plates, 25g chopped brie cheese and a few sunflower seeds. Sprinkle the salad with salt, pepper and pour the sauce. ",
    surecipe3:"Put half a peeled banana in a bowl and crush with a fork. Then add 90g plain yogurt, egg and cinnamon - mix. Add 40g flour and mix again. Fry in a preheated pan with a small amount of oil. Put a spoonful of mass on one cake, brown with both sides. ",
    surecipe4:"40g of flakes pour 100g of milk, boil. Stir constantly, cook for about 3 minutes. Transfer to a bowl. Add a teaspoon of honey, mix. Sprinkle a handful of a mixture of freeze-dried fruit, dried goji berries and coconut.",
    surecipe5:"Peel half of the apple and pear, hollow the center. Wash 15g of kale, cut into pieces. Add 75g of strawberries. Add all ingredients to the blender cup, add 50g of water and mix thoroughly. Drink the cocktail immediately after preparation.",
    surecipe6:"Blend 110g of peeled mango. Blend 110g of seedless watermelon. Put 100g of natural yogurt, mango mousse and mixed watermelon into a glass.",
